<x-layout>
    ...
    <x-slot:metaDescription>Edit and update your expense details easily in SpendLog.</x-slot:metaDescription>
    ...
    <div class="flex flex-col gap-4 mt-4">
        ...
        <div
            ...
            <form class="w-full max-w-lg flex flex-col gap-4" action="{{ route('expenses.update', $expense->id) }}"
                method="POST">
                @csrf
                @method('PATCH')
        ...
        <div
            class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form id="category-form" class="w-full max-w-lg flex flex-col gap-4"
